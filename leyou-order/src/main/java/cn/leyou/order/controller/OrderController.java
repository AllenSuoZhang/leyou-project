package cn.leyou.order.controller;

import cn.leyou.order.service.OrderService;
import cn.leyou.utils.PayHelper;
import cn.leyou.utils.PayState;
import cn.leyou.common.pojo.PageResult;
import cn.leyou.order.pojo.Order;
...
public class OrderController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "page", value = "当前页", defaultValue = "1", dataType = "Integer"),
            @ApiImplicitParam(name = "rows", value = "每页大小", defaultValue = "5", dataType = "Integer"),
            @ApiImplicitParam(name = "status", value = "订单状态：1未付款，2已付款未发货，3已发货未确认，4已确认未评价，5交易关闭，6交易成功，已评价", dataType = "Integer"),
    })
    @ApiResponses({
